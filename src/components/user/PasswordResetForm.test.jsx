...
describe("PasswordResetForm", () => {
  ...
  test("should display general error when submitting form and response is not ok", async () => {
    ...
    expect(
      screen.getByText("Nie udało się wysłać linku resetującego hasło!")
    ).toBeInTheDocument();
  ...
  test("should send form successfully", async () => {
    ...
    expect(
      screen.getByText("Link do resetowania hasła został wysłany.")
    ).toHaveClass("py-6 text-green-500");
