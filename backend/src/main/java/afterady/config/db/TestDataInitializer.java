...
public class TestDataInitializer {
    ...
    public TestDataInitializer(AdviceRepository adviceRepository, CategoriesStatisticsRepository categoriesStatisticsRepository, CronJobsService cronJobsService) {
